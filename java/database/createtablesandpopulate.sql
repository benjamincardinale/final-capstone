...
VALUES (3, '"require(''src\assets\BUSTER_01.jpg'')"', 'Cute white fluffy bunny.');

INSERT INTO images (pet_id, url, image_description)
VALUES (1, '"require(''src\assets\COOKIE_01.jpg'')"', 'Golden brown short haired dog licking nose.');

INSERT INTO images (pet_id, url, image_description)
VALUES (2, '"require(''src\assets\VINCENT_01.jpg'')"', 'Young gray and black kitten.');

INSERT INTO images (pet_id, url, image_description)
VALUES (4, '"require(''src\assets\WAFFLES_01.jpg'')"', 'Young chocolate lab.');
